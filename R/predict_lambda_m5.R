predict_lambda_m5 <- function(
  ...
  x_intercovs_predict <- cbind(x_subrealm_predict, x_soiltype_predict)
  x_interactions_predict <- make_designmat_interactions(
    x_predict,
    x_intercovs_predict
  )
  x_all_predict <- cbind(x_predict,  x_subrealm_predict, x_interactions_predict)
