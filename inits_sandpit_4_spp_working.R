...
# tar_load_everything()
#
# save.image(file = "working_4_species_data.RData")
# saving above because that is the data set (variables etc) that converges OK
# loading in from saved RData so it's kept in a time-capsule and I don't bugger
# it up again
library(targets)
tar_load_globals()
load("working_4_species_data.RData")



# if doing on 4 species to replicate NG original working model
